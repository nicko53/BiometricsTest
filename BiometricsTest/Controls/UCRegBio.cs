...
{
    public partial class UCRegBio : UserControl
    {
                ...
                case MESSAGE_CAPTURED_OK:
                    {
                        ...
                        if (IsRegister)
                        {
                            ...
                            if (RegisterCount >= REGISTER_FINGER_COUNT)
                            {
                                ...
                                {
                                    textRes.Text = "enroll failed, error code=" + ret;
                                }
                                IsRegister = false;
                                return;
                            }
                        ...
                        else
                        {
                            ...
                            if (bIdentify)
                            {
                                ...
                                if (zkfp.ZKFP_ERR_OK == ret)
                                {
                                    textRes.Text = "Identify success, fid= " + fid + ",score=" + score + "!";
                                    return;
                                }
                                else
                                {
                                    textRes.Text = "Identify failed, ret= " + ret;
                                    return;
                                }
                            }
                            else
                            {
                                ...
                                if (0 < ret)
                                {
                                    textRes.Text = "Match finger success, score=" + ret + "!";
                                    return;
                                }
                                else
                                {
                                    textRes.Text = "Match finger failed , ret= " + ret;
                                    return;
                                }
                            }
                        }
        ...
        private void UCRegBio_Load(object sender, EventArgs e)
        {
